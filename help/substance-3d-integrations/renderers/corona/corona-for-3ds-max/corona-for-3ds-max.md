...
Mit dem [3ds Max-Plugin](../../../3d-applications/3ds-max/3ds-max.md) können Sie Corona im Substance-Menü auswählen, um das Corona-Material automatisch mit Substance-Textur-Eingängen einzurichten.
...
* **LiftGamaGain** wird zwischen der Ausgabe der Grundfarbe und der Eingabe der Grundfarbe erstellt. Ein Gamma-Wert von 0,455 wird zur Korrektur der Farbdifferenz verwendet.
