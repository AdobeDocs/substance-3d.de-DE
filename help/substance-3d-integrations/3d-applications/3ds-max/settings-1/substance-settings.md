...
1. **Speicherbudget/CPU-Kerngrenze**: Dies sind Optimierungseinstellungen für das Substance Engine. Im Falle von Multitasking oder Rendering können diese Einstellungen angepasst werden, um die Hardwareressourcen, die das Substance Engine in einem Leistungskompromiss verwendet, zu reduzieren.

   ![](https://helpx-prod.scene7.com/is/image/HelpxProd/max5?$png$&jpegSize=100&wid=602)
