...
breadcrumb-title: ''
description: Referenzdokumentation für die SubstanceRuntime-Klasse, die für Vorgänge zum Substance von Laufzeitmaterial in Unity verwendet wird.
...
Singleton-Klasse, die die Substance-Engine-Initialisierung behandelt, und wird verwendet, um systemeigene Handler an Substance-Instanzen zu übergeben.\
Vererbungsdiagramm für Adobe.Substance.Runtime.SubstanceRuntime:
