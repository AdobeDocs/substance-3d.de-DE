...
| **Normale Ausrichtung** | Definiert das normale Format der Eingabetextur, wenn **Zuordnungstyp** auf **Tangentialraum** festgelegt ist.Mögliche Werte:<ul data-preserve-html="true"><li data-preserve-html="true"><strong>OpenGL</strong></li><li data-preserve-html="true"><strong>DirectX</strong> (Standard)</li></ul> |
