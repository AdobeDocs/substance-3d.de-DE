...
Es gibt kein formelles Zertifizierungsverfahren, daher kann der Anspruch verschiedene Dinge bedeuten. In der Praxis variieren die Implementierungen: Einige decken die gesamte Spezifikation ab, andere nur eine Untermenge. Dabei werden Merkmale wie Dünnschicht, Streuung oder bestimmte Untergrundverhalten ausgelassen. Beachten Sie auch, dass &quot;MaterialX-Unterstützung&quot; und &quot;OpenPBR-Unterstützung&quot; nicht dasselbe sind. Eine Anwendung kann eine Anwendung unterstützen, ohne die andere vollständig zu implementieren.

Um herauszufinden, was eine bestimmte Anwendung tatsächlich unterstützt, verwenden Sie eine Kombination von Ansätzen: Lesen Sie die Versionshinweise (Support wird häufig schrittweise hinzugefügt). Laden Sie den OpenPBR Shader Playground des ASWF und vergleichen Sie ihn mit einem Referenz-Rendering, um Lücken schnell zu überdecken. oder bei Studios mit erheblichen Pipeline-Investitionen den Anbieter direkt nach den unterstützten Funktionen und deren Roadmap fragen.
...
In der Praxis bedeutet die Maximierung dieser Garantie: Exportieren über USD mit MaterialX-Integration; frühzeitige Validierung der Hin- und Rückfahrt mithilfe des OpenPBR Shader Playground des ASWF und nicht am Ende der Produktion; Bestätigung der Support-Level Ihrer Anbieter für alle von Ihnen verwendeten erweiterten Funktionen; und im Voraus zustimmen, welche Funktionen in freigegebenen Materialien verwendet werden und welche nicht. Portabilität sollte aktiv validiert werden, nicht vorausgesetzt.

+++

+++Gibt es Materialien, die OpenPBR nicht genau darstellen kann?

Ja. OpenPBR ist ein parametrisches Modell. Parameter wie Raueit, Metallität und IOR decken den größten Teil der Anwendungsfälle in der Produktion ab, können jedoch nicht die Genauigkeit gemessener Materialformate wie X-Rite AxF replizieren, die tatsächliche optische Daten aus einer physischen Probe erfassen. Für allgemeine Produktionsarbeiten ist OpenPBR gut geeignet; bei Anwendungen, die eine exakte Stichprobenübereinstimmung erfordern, kann ein gemessenes Format geeigneter sein.

Autolack ist eine nützliche Illustration. Es ist möglich, Autolack in OpenPBR mit einigen Einschränkungen zu erstellen. OpenPBR bietet keinen speziellen Autolack-Shader, sodass er für bestimmte Anwendungen in der Automobilindustrie möglicherweise nicht ausreicht. Darüber hinaus hängt es einfach von der Art der Autolacke ab - einige Autolacke haben immer Eigenschaften, die außerhalb des Anwendungsbereichs eines bestimmten Shaders liegen. Aber mit diesen Argumenten verknüpft Autolack ganz natürlich die geschichtete Architektur von OpenPBR.
...
Nein. Für die meisten Künstler ist OpenPBR einfach das Materialmodell, das in den Tools enthalten ist, die sie bereits verwenden. Substance 3D Painter, Maya 2025.3 und 3ds Max 2026 verwenden alle OpenPBR als Standardmaterial. Dafür musst du nur mit dem Standard-Shader arbeiten. USD und MaterialX werden nur relevant, wenn Materialien zwischen Anwendungen verschoben werden müssen. Bei Arbeitsabläufen mit nur einer Anwendung ist die native Unterstützung ausreichend. für Multi-DCC-Pipelines stellen USD und MaterialX die Austauschinfrastruktur bereit, jedoch weitgehend hinter den Kulissen.

Der zuverlässigste Austauschpfad für gemeinsam genutzte Materialbibliotheken ist jedoch die Verwendung von USD mit MaterialX-Integration, die einen standardisierten Container für Materialbeschreibungen bietet, der vom Renderer unabhängig ist. Arbeitsabläufe für den Export von Materialien als eigenständige Elemente (ohne zugehöriges Modell, zur Verwendung in einer freigegebenen Bibliothek) befinden sich noch in der aktiven Entwicklung und werden noch nicht überall vollständig unterstützt. Bevor Sie einen Commit für eine davon abhängige Bibliotheksarchitektur ausführen, sollten Sie Ihre spezifische Pipeline anhand der aktuellen Funktionen überprüfen.

+++

+++Wie erstelle ich in Substance 3D Painter ein neues OpenPBR-Projekt?

Ein Projekt, das ohne Vorlage erstellt wurde, verwendet standardmäßig den OpenPBR-Shader. Der OpenPBR-Shader ist jetzt die erste Option im neuen Projektfenster und ersetzt ASM. Für spezifische Workflows (Anisotropie, Beschichtung, Fuzz, Untergrundstreuung) stehen ebenfalls spezielle Vorlagen zur Verfügung. Beim Importieren einer USD-Datei mit einem OpenPBR-Material wird das Projekt automatisch konfiguriert. Die Beispielprojekte, die mit Substance 3D Painter ausgeliefert wurden, wurden ebenfalls auf den OpenPBR-Arbeitsablauf aktualisiert und sind ein guter Ausgangspunkt, um sich mit der Funktionsweise in der Praxis vertraut zu machen.

+++

+++Kann ich ein bestehendes Adobe Standardmaterial (ASM)-Projekt in ein OpenPBR-Projekt konvertieren?
...
Um manuell zu OpenPBR zu migrieren, wählen Sie den OpenPBR-Shader im Fenster &quot;Shader-Einstellungen&quot; aus und fügen Sie dann die entsprechenden OpenPBR-Kanäle über &quot;Textursatzeinstellungen&quot; > &quot;Kanäle hinzufügen oder entfernen&quot; hinzu. Überprüfe anschließend deine vorhandenen Ebenen, um sicherzustellen, dass ihre Inhalte auf die gewünschten Kanäle abzielen.

+++

+++Müssen meine benutzerdefinierten Shader für OpenPBR aktualisiert werden?

Nein - vorhandene benutzerdefinierte Shader funktionieren weiterhin, da die entsprechenden Shader-Bibliotheken veraltet sind und nicht entfernt werden. Es wird jedoch empfohlen, zu den neuen Shader-Bibliotheken zu migrieren. sie sind sauberer und leichter zu bearbeiten. Weitere Informationen finden Sie im Shader-API-Änderungsprotokoll im Hilfemenü.
